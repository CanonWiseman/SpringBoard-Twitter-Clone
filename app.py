...
app.config['SQLALCHEMY_DATABASE_URI'] = (
    os.environ.get('DATABASE_URL', 'postgresql://postgres:' + databaseKey + '@localHost:5432/warbler'))
...
@app.route('/users/profile/<user_id>', methods=["GET", "POST"])
def profile(user_id):
...
def homepage():
    ...
    if g.user:
        ...
        return render_template('home.html', messages=messages, liked = liked_messages)
